...
window.TMS={branches,supervisors,vehicles,drivers,clients,customers,locations,routes,bunks,trips,exceptions,gpsLog,users,permissions,distanceChecks,radiusAlerts,supervisorNotices,
 B:byId(branches),S:byId(supervisors),V:byId(vehicles),D:byId(drivers),C:byId(clients),U:byId(customers),L:byId(locations),R:byId(routes),F:byId(bunks),T:byId(trips)};
})();
